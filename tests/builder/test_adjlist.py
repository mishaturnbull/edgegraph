...
def test_adjlist_build_clrs09_22_1():
    ...
    assert (
        v[3].links[0].other(v[3]) is v[1]
    ), "v3 -- v1 (back) link is not right!"
    assert (
        v[3].links[1].other(v[3]) is v[2]
    ...
    assert (
        v[4].links[0].other(v[4]) is v[0]
    ), "v4 -- v0 (back) link is not right!"
    assert (
        v[4].links[1].other(v[4]) is v[1]
    ), "v4 -- v1 (back) link is not right!"
    assert (
        v[4].links[2].other(v[4]) is v[3]
